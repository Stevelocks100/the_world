...
function theworld:muda_muda/zzz/3 with entity @s data
execute positioned ~-0.75 ~-0.75 ~-0.75 as @e[tag=theworld.living_entity,dx=0.5,dy=0.5,dz=0.5,tag=!theworld.current_owner,distance=0..10] run function theworld:muda_muda/zzz/4
